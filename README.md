...
## + Review
다른 인원의 리뷰에서,  
스마트 포인터는 오히려 해제 시점은 명확하게 하지 못하게 한다는 문제가 제기되었다.  
해제시점이 명확하지만 스마트 포인터의 사용으로 가려지는 부분들이 몇 군데 있어, 이에 동의하였고  
c/c++의 장점을 오히려 이용하지 못 한다는 느낌이라  
지금 스마트 포인터로 삭제되는 채널은 로우한 포인터로 관리하는게 맞을 것 같다.  
